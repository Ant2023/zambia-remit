...
EMAIL_SERVICE_PROVIDER = env("EMAIL_SERVICE_PROVIDER", "django_email_backend")
EMAIL_SERVICE_CONFIGS = env_json("EMAIL_SERVICE_CONFIGS")
RESEND_API_KEY = env("RESEND_API_KEY", "")
RESEND_BASE_URL = env("RESEND_BASE_URL", "https://api.resend.com").rstrip("/")
SMS_SERVICE_PROVIDER = env("SMS_SERVICE_PROVIDER", "deferred")
SMS_SERVICE_CONFIGS = env_json("SMS_SERVICE_CONFIGS")
...
PAYOUT_PROVIDER_CONFIGS = env_json("PAYOUT_PROVIDER_CONFIGS")
PAYOUT_WEBHOOK_SECRETS = env_map("PAYOUT_WEBHOOK_SECRETS")
KYC_PROVIDER = env("KYC_PROVIDER", "manual_kyc_review")
KYC_PROVIDER_CONFIGS = env_json("KYC_PROVIDER_CONFIGS")
SANCTIONS_AML_PROVIDER = env("SANCTIONS_AML_PROVIDER", "manual_sanctions_review")
SANCTIONS_AML_PROVIDER_CONFIGS = env_json("SANCTIONS_AML_PROVIDER_CONFIGS")
FX_RATE_SOURCE = env("FX_RATE_SOURCE", "database")
FX_RATE_SOURCE_CONFIGS = env_json("FX_RATE_SOURCE_CONFIGS")
PROVIDER_USE_ENV_PROXY = env_bool("PROVIDER_USE_ENV_PROXY", False)
